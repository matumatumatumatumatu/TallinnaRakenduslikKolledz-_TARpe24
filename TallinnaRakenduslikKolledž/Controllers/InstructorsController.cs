...
namespace TallinnaRakenduslikKolledž.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        {
            Instructor deleteableInstructor = await _context.Instructors
                .SingleAsync(i => i.ID == id);
            _context.Instructors.Remove(deleteableInstructor);
            await _context.SaveChangesAsync();
            return RedirectToAction("Index");
        }
        ...
        public async Task<IActionResult> Edit([Bind("ID,LastName,FirstName,HireDate,Salary,Age,Department,Course")] Instructor instructor)
        {
            if (ModelState.IsValid)
            {
