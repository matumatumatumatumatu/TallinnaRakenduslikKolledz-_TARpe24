...
namespace TallinnaRakenduslikKolledž.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Edit([Bind("DepartmentID,Name,Budget,StartDate,RowVersion,InstructorID,SigmaStatus,EndDate,SocialCreditScore")] Department department)
        {
            if (ModelState.IsValid)
            {
