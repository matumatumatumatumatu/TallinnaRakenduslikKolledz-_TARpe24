        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstructorIDˇ = table.Column<int>(type: "int", nullable: true),
                    AdministratorID = table.Column<int>(type: "int", nullable: true),
                    RowVersion = table.Column<byte>(type: "tinyint", nullable: true),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SocialCreditScore = table.Column<int>(type: "int", nullable: true),
                    SigmaStatus = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
